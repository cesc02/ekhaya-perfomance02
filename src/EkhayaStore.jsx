          ...
          {step === "payment" && (
            <>
              <div className="pay-method-row">
                ...
                <button className={`pay-method ${method === "mpamba" ? "active" : ""}`} onClick={() => setMethod("mpamba")} style={method === "mpamba" ? { borderColor: "#00a651", background: "#e6f7ee" } : undefined}>
    ...
    <div className="ekhaya">
      ...
      <div className="trust-strip">
        <div className="trust-item">
          ...
          <div><h4>Nationwide delivery</h4><p>Dispatched within 48 hours of order</p></div>
        </div>
        <div className="trust-item">
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <div className="footer-cols">
            ...
            <div>
              <h5>Help</h5>
              <a href="#">Order status</a><a href="#">Returns</a><a href="#">Contact us</a>
            </div>
            <div>
              <h5>Club</h5>
